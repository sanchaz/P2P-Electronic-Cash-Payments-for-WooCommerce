 ...
 */
class ECP_Bitcoin_Cash extends ECP_Bitcoin {
	...
	public function get_payment_method_title() {
		return __( 'Bitcoin Cash', 'woocommerce' );
	}
	...
	public function get_electrum_util() {
		return new ElectrumBCHUtil( $this->settings['electrum_mpk'], $this->settings['starting_index_for_new_btc_addresses'] );
	}
	...
	public function update_order_metadata( $order_id, $ret_info_array ) {
		...
		ECP__log_event( __FILE__, __LINE__, '     Generated unique bitcoin ' . $this->get_bitcoin_variant() . " address: '{$bitcoins_address}'||'{$bch_cashaddr}' for order_id " . $order_id );
	...
	public function default_payment_instructions() {
		$payment_instructions = '
              ...
              <tr class="bpit-table-row">
                ...
                <td class="bpit-td-value bpit-td-value-qr">
                  <div style="padding:2px 0px;">
                    <a href="{{{BCH_CASHADDR}}}?amount={{{BITCOINS_AMOUNT}}}&message={{{PAYMENT_MESSAGE}}}"><img src="https://api.qrserver.com/v1/create-qr-code/?color=000000&amp;bgcolor=FFFFFF&amp;data={{{BCH_CASHADDR_URL_SAFE}}}%3Famount%3D{{{BITCOINS_AMOUNT}}}%26message%3D{{{PAYMENT_MESSAGE_URL_SAFE}}}&amp;qzone=1&amp;margin=0&amp;size=180x180&amp;ecc=L" style="vertical-align:middle;border:1px solid #888;" /></a>
                  </div>
                </td>
              </tr>
            </table>
            ...
            <ol class="bpit-instructions">
                <li>' . __( 'The payment method chosen ONLY accepts Bitcoin Cash! Bitcoin (legacy/core/segwit/sv) payments will not process and the money will be lost forever!', 'woocommerce' ) . '</li>
